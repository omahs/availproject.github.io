...
The Avail light client challenge will run from **2nd April 2024 to 9th April 2024**. This guide serves
...
We have partnered with Blobscriptions for this challenge. You can visit the [Avail light client challenge page](https://lightclient.availproject.org/) to sign up for the challenge.
...
Even though the Light client lift-off challenge is **NOT** a part of the clash of nodes, the same terms and conditions apply.
We highly recommend you go through them before participating in the challenge.

They are available [in our docs here](/docs/clash-of-nodes/toc).
...
2. The light client will log a random public key when it first initializes. Make sure to note down this public key.
This is how it looks:

<p align="center"><img src="/img/lc-public-key.png" alt="Avail-light-client-address" width="95%"/></p>

3. Once you have this public key, go to the Light Client Lift-off challenge page and connect your substrate wallet. <br/>
A unique *address-public key* pair consisting of your Substrate account and the light client public key will be generated.
...
<Callout type="info">
In addition to the main lift-off challenge, you can also complete optional tasks and get verified
to earn additional Zaps and increase your chances of landing rewards.
</Callout>
