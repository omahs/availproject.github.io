...
We have partnered with Blobscriptions for this challenge. You can go to their website to sign up for the challenge.
...
<Callout type="info">
Please note that the Avail light client was desgined from the ground up to be an efficient piece of software
with minimal hardware requirments.
...
[documentation](/docs/pages/docs/operate-a-node/run-a-light-client/light-client-api-reference.mdx).
</Callout>
...
3. Once you have this address, go to blobscription's website and connect your substrate wallet. Use their
interface to sign up for the challenge. <br/>
A unique address pair consisting of your Substrate account and the light client address will be generated.
They should be unique and neither can be reused. The rewards for the chalenge will be sent to the Substrate account address.