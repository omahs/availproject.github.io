...
| ------------------------------------------------------------------------ | ------------- | ------- | ------------------------ | ------------------------------------------------------------------------------------ |
| [<ins>Run a Light Client</ins>](/docs/operate-a-node/run-a-light-client/0010-light-client.mdx) | No            | No      | Basic                    | [<ins>v1.7.4</ins>](https://github.com/availproject/avail-light/releases/tag/v1.7.4) |
| [<ins>Run a Full Node</ins>](/docs/operate-a-node/run-a-full-node/requirements)                       | No            | No      | Moderate                 | [<ins>v1.8.0.4</ins>](https://github.com/availproject/avail/releases/tag/v1.8.0.4)   |
| [<ins>Become a Validator</ins>](/docs/operate-a-node/become-a-validator/0000-already-running-full-node)           | Yes           | Yes     | Advanced                 | [<ins>v1.8.0.4</ins>](https://github.com/availproject/avail/releases/tag/v1.8.0.4)   |
...
- [<ins>TypeScript Instructions</ins>](https://github.com/availproject/avail/blob/develop/examples/ts/README.mdx)
- [<ins>Go Instructions</ins>](https://github.com/availproject/avail/blob/develop/examples/go/README.mdx)
- [<ins>Rust Instructions</ins>](https://github.com/availproject/avail/blob/develop/avail-subxt/examples/README.mdx)
