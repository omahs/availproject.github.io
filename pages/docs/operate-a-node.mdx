...
<Cards>
  ...
  <Card icon={<FilesIcon />} title="Run a Light Client" href="/docs/operate-a-node/run-a-light-client" />
  <Card icon={<FilesIcon />} title="Run a Full Node" href="/docs/operate-a-node/run-a-full-node" />
