...
We don’t know anything about an airdrop.
...
- Join the [Avail Uncharted](https://github.com/availproject/avail-uncharted) Technical Contributor's programme

## How do I get in touch if I have questions?

- Partnerships → [partnerships@availproject.org](mailto:partnerships@availproject.org)
...
Celestia is doing amazing work and they have helped move the industry forward. The level of responsiveness we need to enable a unified web3 ecosystem relies upon a validity proof based modular DA construction. Avail was designed from the ground up, leveraging first principles thinking to enable a unification layer for web3, and it achieves this by leveraging ZK technology on the DA layer and DAS. 

## Is AvailDA same as EigenDA?

Avail is building a unification layer for web3 which is why we needed to build Avail DA from the ground up. Eigen are doing great work, and their restaking model helped inspire our Fusion Security model, albeit with some important modifications for our use case.
