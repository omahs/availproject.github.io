...
In order to cover Avails consensus we must cover

- **Nominated Proof of Stake (NPOS)** which focuses on who is allowed to take part in consensus
...
Let's dig deeper into Nominated Proof of Stake (NPOS) first.
